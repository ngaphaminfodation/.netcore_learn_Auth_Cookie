...
namespace CookieReader.Providers
{
    ...
    {
        public async Task SignIn(HttpContext httpContext, CookieUser user, bool isPersistent = false)
        {
        ...
        private List<Claim> GetUserClaims(CookieUser user)
        {
